...
Radiovågen är därmed en sorts elektromagnetisk strålning. En del människor är rädda för strålning men man skall komma ihåg att det finns olika sorters elektromagnetisk strålning, så kallad joniserande strålning och icke-joniserande strålning. 

Studera figuren \ref{fig:em-spektrum} som visar skillnaderna. En joniserande strålning har tillräckligt med energi för att få elektroner att lämna sin atom och skapa en jon. Detta kallas för \textit{joniserande strålning} och ibland för \textit{radioaktiv strålning}.

Om en elektromagnetisk våg är joniserande eller inte bestäms enbart av dess frekvens och för att bli joniserande måste frekvensen vara mycket hög, högre än synligt ljus vilket radiovågor inte är. Radiovågor är tvärt om den lägsta delen av det elektromagnetiska spektrat (den formella definitionen är 9~kHz till 3~THz) alltså icke-joniserande och skall därför inte blandas ihop med radioaktiv strålning.
...
Här betecknar $f$ frekvensen i MHz och $\lambda$ (lambda) våglängden i meter. $V_C$ är ljusets hastighet och normalt använder vi 300 om vi har frekvensen i MHz och våglängden i meter.
