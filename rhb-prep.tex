...
\begin{table}[!hp]
	...
	\begin{tabular}{rr|rr}
		Watt & dBm & dBm & Watt \\ \hline
		 ...
		 100 &     &     &
	\end{tabular}
	\caption{Översättning mellan Watt och dBm}
	\label{tab:oversattning-w-dBm}
	\todo[inline]{Inte färdig tabell}
\end{table}
...
\begin{tabular}{rl}
	Faktor & Terrängbeskrivning                            \\ \hline
	     ...
	     5 & Flack terräng eller utbredning över vatten    \\
	    10 & Bebyggd glesbygd eller kulligare terräng      \\
	    15 & Tät bebyggelse eller bergig terräng           \\
	    20 & Mycket urban bebyggelse, extremt svår terräng \\
	    25 & Torr stenöken
\end{tabular}
...
Vi väljer terrängfaktorn 15 för denna beräkning.

\subsubsection{Slutför beräkningen}

\begin{equation}
L_P=20\cdot\log(156)+(20+10)\cdot\log(5)+32,45 = 43,9 + 21,0 + 32,45 = 97,35
\end{equation}

Om inga andra störningar finns så bör förbindelsen kunna fungera. Observera att detta gäller endast när både sändare och mottagare befinner sig på relativt höga och fria positioner mot omgivningen. 

Är man nere i terränglådan kan förbindelserna förkortas avsevärt.
